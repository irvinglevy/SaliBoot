...
//#define IRVING_TEST
    ...
    Delay(3);
    HWREG(GPIO_PORTC_BASE + GPIO_O_DEN) |= 1 << 6;
    HWREG(GPIO_PORTC_BASE + GPIO_O_DR2R) |= 1 << 6;
    HWREG(GPIO_PORTC_BASE  + GPIO_O_DIR) |= 1 << 6;
    Delay(10);
    HWREG(GPIO_PORTC_BASE + (GPIO_O_DATA + (0x40 << 2))) = 0x40;
    while(1);
    #endif
    //
